...
COMMENT ON COLUMN cz_mi.armitc.tecnico IS 'Identificador del tecnico';
COMMENT ON COLUMN cz_mi.armitc.no_prove IS 'Numero de proveedor (FK a cz_in.arinmp).';
COMMENT ON COLUMN cz_mi.armitc.identificacion IS 'Numero de documento de identidad.';
COMMENT ON COLUMN cz_mi.armitc.tipo_identificacion IS 'Tipo de documento.';
